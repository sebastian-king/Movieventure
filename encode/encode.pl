...
my $CONF_ITEM_BACKUP_DIR = "/home/encode/items";
...
# TMP PUSH
system("/home/encode/push.sh 'Begun encoding - $INPUT_NAME' 'ID: $INPUT_ID\\nNAME: $INPUT_NAME\\nHASH: $INPUT_HASH\\nDIR: $INPUT_DIR\\nTIME: $date'");
...
# TMP PUSH
system("/home/encode/push.sh 'Concat.: $CONCAT_FILES - $INPUT_NAME' 'Deciding factor: ...'");
...
# TMP PUSH
system("/home/encode/push.sh 'Finished encoding - $INPUT_NAME' 'ID: $INPUT_ID\\nNAME: $INPUT_NAME\\nHASH: $INPUT_HASH\\nDIR: $INPUT_DIR\\nTIME: $date\\nEXECUTION TIME: " . (gettimeofday - $timestamp) . "'");
