	...
	do {
		...
		if (empty($_POST['first_name'])) {
			...
			$q = $db->query("INSERT INTO `users`
				...
				setcookie("MOVIEVENTURE_SESSION_ID", $auth_session_id, 0, '/', $root_domain, true, true);
				setcookie("MOVIEVENTURE_SESSION_NAME", $auth_session_name, 0, '/', $root_domain, true, true);
